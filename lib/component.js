...
export class Component extends extend_as("Component").mixins(
  ...
  static create({ name=null, template_name=null, container=null, attrs={} }={}) { return this.createFromTemplate({ name: name, template_name: name, container: container, attrs: attrs })}
