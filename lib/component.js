...
export class Component extends extend_as("Component").mixins(
  ...
  */
  ...
  _listenToNativeEvents() {
    ...
    this.native_events.forEach(function(e) {
      ...
      if(e.includes('.')) {
        ...
        if(part_els != null && part_els.length > 0) {
          let self = this;
          part_els.forEach(function(part_el) {
            part_el.addEventListener(event_name, function(native_event) {
      ...
      // Event belongs to our component's dom_element
        ...
        let self = this;
        this.dom_element.addEventListener(e, function(native_event) {
  ...
  _flattenNativeEvents() {
    ...
    this.native_events.forEach(function(event) {
      if(/\[.*?\]/.test(event)) {
