...
export function I18n(names) {
  return new _I18n(names);
}

class _I18n {

  constructor(names="i18n") {
  ...
  t(key, args=null) {
    ...
    if(value == null) {
      if(this.print_console_warning)
        console.log(`WARNING: translation missing for \"${key}\" in \"${this.names.join(",")}\" translator(s).`);
