export const ComponentDom = (ComponentDom) => class extends ComponentDom {
  ...
  _readPropertyFromNode(property_name, { run_calllback=false }={}) {
    ...
    if(property_el != null) {
      ...
      if(pa != null) {
        ...
        this._assignPropertyFromNodeStringValue(property_name, property_el.getAttribute(`data-${property_name.replace(/_/g, "-")}`));
      }
      else {
