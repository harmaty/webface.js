export const ComponentDom = (ComponentDom) => class extends ComponentDom {
  ...
  _initTemplate() {
    if(this.template_name == null)
      ...
      return this.template = this.constructor.owner_document.querySelector(`[data-component-template=${this.constructor.name}][data-component-template-name=${this.template_name}]`);
