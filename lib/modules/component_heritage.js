  ...
  */
  ...
  findAllDescendantsByRole(role) {
    ...
    this.children.forEach(function(c) {
      ...
      // there might be nested components with the same roles, but it's a good idea to
      // go to deep - these would be very complicated edge cases and the behavior may not
      // even be desirable.
